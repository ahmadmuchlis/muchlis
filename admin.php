    ...
    <div class="container" style="width: 95%;">
      <div class="card">
        <div class="card-content">
          <h1 class="black-text text-tahoma-2 center" style="font-weight: 600;letter-spacing: -2px;">Selamat Datang di Kearsipan <br> <span class="blue-text text-lighten-1">SMK Negeri 5 Kota Bekasi</span></h1>
        </div>
      </div>
    </div>
  </div>
